    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Hospital>().HasData(
                new Hospital { HospitalId = 1, HospitalName = "Apolo Hyd Branch", IsActive = true, CreatedAt = DateTime.Now },
                new Hospital { HospitalId = 2, HospitalName = "Apolo Mumbai Branch", IsActive = true, CreatedAt = DateTime.Now }
